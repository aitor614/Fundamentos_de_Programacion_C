...
void segundoArray(float* tol, float* tolMax, float* tolMin, int arreglo2[10], int arreglo[10], float* media) {
	...
	printf("****************FUNCION QUE MUESTRA LOS NUEROS INTRODUCIDOS EN AMBOS ARRAYS:****************\n\n");
	...
	for (int i = 0; i < 10; i++) {
		...
		//Introducimos los numeros que esten etre la tolerancia, en un segundo array
